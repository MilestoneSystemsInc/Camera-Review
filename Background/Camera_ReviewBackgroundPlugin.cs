...
namespace Camera_Review.Background
{
    /// <summary>
    ...
    /// </summary>
    public class Camera_ReviewBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return Camera_ReviewDefinition.Camera_ReviewBackgroundPlugin; }
        }
        ...
        {
            get { return "Camera_Review BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "Camera_Review Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "Camera_Review background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "Camera_Review background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
