...
{
    public class Camera_ReviewTabPlugin : TabPlugin
    {
        ...
        {
            get { return Camera_ReviewDefinition.Camera_ReviewTabPluginId; }
        }

        public override Image Icon
        {
            get { return Camera_ReviewDefinition.TreeNodeImage; }
        }
        ...
        public override TabUserControl GenerateUserControl(Item item)
        {
            ...
            return new Camera_ReviewTabUserControl(item);
        }
