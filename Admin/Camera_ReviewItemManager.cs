...
namespace Camera_Review.Admin
{
    ...
    /// </summary>
    public class Camera_ReviewItemManager : ItemManager
    {
        private Camera_ReviewUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public Camera_ReviewItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new Camera_ReviewUserControl();
        ...
        {
            return new Camera_ReviewAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(Camera_ReviewDefinition.Camera_ReviewPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((Camera_ReviewAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(Camera_ReviewDefinition.Camera_ReviewPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(Camera_ReviewDefinition.Camera_ReviewPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(Camera_ReviewDefinition.Camera_ReviewPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(Camera_ReviewDefinition.Camera_ReviewPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(Camera_ReviewDefinition.Camera_ReviewPluginId, _kind, fqid.ObjectId);
            return item;
        }
